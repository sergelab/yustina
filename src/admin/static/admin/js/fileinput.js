...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        buttonLabelClass: 'uk-hidden-small',
        browseIcon: '<i class="uk-icon-folder-open"></i>&nbsp;',
        browseClass: 'uk-button uk-button-primary',
        removeIcon: '<i class="uk-icon-trash"></i>',
        removeClass: 'uk-button uk-button-danger',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'uk-button',
        uploadIcon: '<i class="uk-icon-upload"></i>',
        uploadClass: 'uk-button uk-button-primary',
        uploadUrl: null,
        uploadAsync: true,
        uploadExtraData: {},
        minImageWidth: null,
        ...
        progressThumbClass: "uk-progress-bar uk-progress-bar-success uk-progress-bar-striped active",
        progressClass: "uk-progress-bar uk-progress-bar-success uk-progress-bar-striped active",
        progressCompleteClass: "uk-progress-bar uk-progress-bar-success",
        progressErrorClass: "uk-progress-bar uk-progress-bar-danger",
